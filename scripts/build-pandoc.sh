...
#   --out-basename NAME     Base du nom de sortie (def: Dossier-projet)
...
OUT_BASENAME="${OUT_BASENAME:-Dossier-projet}"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --out-basename) OUT_BASENAME="${2:-Dossier-projet}"; OUT_MD="${OUT_BASENAME}.md"; OUT_PDF="${OUT_BASENAME}.pdf"; shift 2;;
